...
（3）作者的经验是，温病患者，具备典型症征，如发热，汗出、口渴、舌红绛、脉滑数等，固然不可运用辛温发汗剂；既使临床上有发热恶寒无汗等表证，只要同时具有口渴、脉滑数、舌红绛等阴虚里热症者，或患者平素体质系属阴虛内热者，亦均不宜使用辛温发汗解表法。举例为证：
...
附注：在同一阶段中，遇有3例肺部霉菌虛染病例，均医治无效，本例亦为霉菌继发感染，故家属要求转院。
